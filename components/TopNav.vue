    ...
    >
      ...
      >
        <div :class="route.fullPath === '/' ? 'w-[80%]' : 'lg:w-[20%] w-[70%]'">
          <NuxtLink to="/">
            <img width="115" src="~/assets/images/tiktok-logo.png" alt="TikTok Logo" />
          </NuxtLink>
        ...
        <div class="flex items-center justify-end gap-3 min-w-[275px] max-w-[320px] w-full">
            ...
            <div  v-if="false" class="flex items-center">
                <button 
                    ...
                    class="flex items-center bg-[#F02C56] text-white border rounded-md px-3 py-[3px]"
                >
                    <span class="mx-4 font-medium text-[14px]">Log in</span>
                </button>
